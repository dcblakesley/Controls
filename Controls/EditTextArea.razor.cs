...
public partial class EditTextArea : EditTextInputBase
{
    ...
    {
        // Chained FIRST so the base's FocusOnFirstRender handling still runs -- the first-render branch
        // below returns early, which used to skip anything the base wanted to do on exactly that render.
