...
#pragma warning restore CS8714
    ...
    // Names kept local because Select.razor binds them; the glyphs themselves come from the shared
    // registries so a coordinate can't drift between copies. Only the caret needs its own wrapper --
    // PickerIcons.DownIcon bakes in the picker's class and omits the 1em sizing.

    static readonly MarkupString ArrowDown = new(
        $"<svg viewBox=\"64 64 896 896\" width=\"1em\" height=\"1em\" fill=\"currentColor\" aria-hidden=\"true\"><path d=\"{PickerIcons.DownPath}\"/></svg>");
    ...
    static readonly MarkupString CloseCross = UiKitIcons.CloseCross;
