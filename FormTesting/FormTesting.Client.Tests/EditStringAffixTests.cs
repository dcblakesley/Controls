...
public class EditStringAffixTests : BunitContext
{
    ...
    public void IsPassword_toggle_reveals_and_re_hides_the_value()
    {
        ...
        Assert.Equal("Show Full Name password", toggle.GetAttribute("aria-label"));
        ...
        Assert.Equal("Show Full Name password", toggle.GetAttribute("aria-label")); // stable name, moving state
