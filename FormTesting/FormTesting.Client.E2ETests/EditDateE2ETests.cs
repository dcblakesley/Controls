...
/// <summary>
/// E2E coverage for the EditDate form control on its own demo view -- the form-integration
...
/// </summary>
public class EditDateE2ETests(AppFixture app, BrowserFixture browser) : DemoPageTestBase(app, browser)
{
    ...
    public async Task Day_click_updates_the_input_value()
    {
        ...
        // First section: a single EditDate bound to a fixed 2026-02-14. Pick a different
        ...
        // EditDate.Format defaults to "MM/dd/yyyy" -- the demo's first section never overrides it.
    ...
    public async Task Required_picker_shows_validation_message_when_empty()
    {
        ...
        // Third section's Required EditDate binds an initially-null [Required] property, and
    ...
    public async Task Month_type_field_commits_the_first_of_the_picked_month_into_the_bound_DateOnly_value()
    {
        ...
        await Expect(dropdown).Not.ToBeVisibleAsync();
        // EditDate's Format is unset, so the picker's Mode.Month default "MM/yyyy" applies --
    ...
    public async Task Mode_Week_field_commits_the_week_start_into_the_bound_DateOnly_value()
    {
        ...
        await Expect(dropdown).Not.ToBeVisibleAsync();
        // EditDate's Format is unset, so the picker's Mode.Week default "yyyy-Www" shorthand
