...
- Two rough edges, left as-is: Enter in a text filter applies without closing the dropdown; a `Row`-placement `Select`/date-range popup can get clipped under `ScrollY`.
