...
- **`Loading` (`bool`)** — shows a translucent mask + spinner over the table body (rows stay rendered beneath it) and sets `aria-busy="true"` on the table wrapper. Pure CSS/markup, no JS.
